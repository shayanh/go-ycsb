...
require (
	...
	github.com/DistCompiler/pgo/systems/raftkvs v0.0.0-20220610235128-65d3947b8463
	github.com/DistCompiler/pgo/systems/raftres v0.0.0-20220610235128-65d3947b8463 // indirect
